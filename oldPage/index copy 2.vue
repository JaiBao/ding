<template>
  <q-page>
    <!-- banner -->
    <div class="full-width indexSection1">
      <NuxtImg format="webp" class="section1Img" src="/overView/0-pic-1.jpg" />
      <div class="section1Title">
        <div class="titleContent">
          <h2>DING TAI SHENG</h2>
          <h6>Scaling High, Conquer for Success</h6>
          <p class="gt-sm">
            問
          ...
          <p class="gt-sm">努力，我們才能攀登最高峰並取得卓越成果。我們致</p>
          <p class="gt-sm">力於突破業界的限制和挑戰，並引領行業的發展和創</p>
          <p class="gt-sm">新。</p>
        </div>
      </div>
    </div>
